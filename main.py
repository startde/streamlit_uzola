...
if selected == "Аналоговые входы":
    ...
    st.image(image_7)
    st.markdown("Была проверена одновременная работа 8 входов модуля. Добавлена логика на включение/выключение дискретных выходов в зависимости от напряжения, измеряемых на аналоговых входах. "
